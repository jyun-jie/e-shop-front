<template>
  <div class="taken-down-container" ref="scrollContainer">
...
const goDelete = async function (proid) {
  try {
    await ElMessageBox.confirm('確認是否刪除此商品？此操作無法復原！', '確認刪除', {
...
.taken-down-container::-webkit-scrollbar {
  width: 8px;
}

.taken-down-container::-webkit-scrollbar-thumb {
  background: #d0d0d0;
  border-radius: 4px;
}
